...
if (__nodeFs.existsSync(__wasmDebugFilePath)) {
  ...
  try {
    __wasmFilePath = __nodePath.resolve('@shined/doctor-binding-wasm32-wasi')
  } catch {
    throw new Error('Cannot find index.wasm file, and @shined/doctor-binding-wasm32-wasi package is not installed.')
  }
}
...
module.exports.innerDebugLint = __napiModule.exports.innerDebugLint
module.exports.innerLint = __napiModule.exports.innerLint
...
module.exports.NapiSeverity = __napiModule.exports.NapiSeverity
