...
export declare class Demo {
  cwd: string
  static create(cwd: string): Demo
  getCwd(): string
}

export declare class Standards {
  static create(cwd: string, opts?: StandardsOpts | undefined | null): Standards
  validateNpmrc(): Promise<Array<NapiMessages>>
  ...
  validateAll(): Promise<Array<NapiMessages>>
}
...
export interface StandardsOpts {
