...
impl Default for EnvironmentFlags {
  fn default() -> Self {
    EnvironmentFlags::Es2024
      | EnvironmentFlags::Browser
      | EnvironmentFlags::Worker
      | EnvironmentFlags::ServiceWorker
  }
}
...
impl Into<EnvironmentFlags> for Environment {
  fn into(self) -> EnvironmentFlags {
    match self {
      ...
      Environment::WebExtensionsApp => EnvironmentFlags::Es2024 | EnvironmentFlags::WebExtensions,
      Environment::GreaseMonkeyApp => EnvironmentFlags::Es2024 | EnvironmentFlags::GreaseMonkey, // Environment::PhantomJSApp => EnvironmentFlags::Es2024 | EnvironmentFlags::PhantomJS,
    }
  }
}
